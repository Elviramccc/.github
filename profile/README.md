...
Pour maintenir une structure de code saine sur nos projets (HCF, Lobby, Core), chaque membre de l'équipe s'engage à :
    ...
    Versionnage : Utiliser des branches distinctes pour chaque nouvelle fonctionnalité (feature/) ou correction (fix/).

    Documentation : Commenter le code complexe et tenir à jour les fichiers de configuration (config.yml).
...
# 🛠️ Projets en cours
    ...
    Security : Gestion des accès, anti-cheat et logs internes.

    Web & API : Liaison entre les serveurs de jeu et nos services externes.

© 2026 ElviraMC — Espace de travail confidentiel.
